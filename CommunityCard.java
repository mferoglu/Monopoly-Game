...
public void ActionOfPay15$toBankAccordingToNumberOfPlayers(String actionOfCard, Player senderPlayer, Bank bank, ArrayList<Player> allPlayers ){
	System.out.println("Community Card has drawn by " + senderPlayer.getName() + "!");
	System.out.println(actionOfCard);
	...
	System.out.println(senderPlayer.getName() + " paid " + (15*(allPlayers.size()-1)) + "$ to bank because of Community Card.");


}

public void ActionOfPay20$ToAllPlayersBecauseGambling(String actionOfCard, Player senderPlayer, ArrayList<Player> allPlayers){
	System.out.println("Community Card has drawn by " + senderPlayer.getName() + "!");
	System.out.println(actionOfCard);
	...
	for (int i = 0; i < allPlayers.size(); i++){
		...
		System.out.println(senderPlayer.getName() + "has paid " + 20 + "$ to " + allPlayers.get(i).getName() + " because of Community Card.");
	}
}
public void ActionOfTake20$FromAllPlayersCard (String actionOfCard, Player senderPlayer, ArrayList<Player> allPlayers){
	System.out.println("Community Card has drawn by " + senderPlayer.getName() + "!");
	System.out.println(actionOfCard);
	...
	for (int i = 0; i < allPlayers.size(); i++){
		...
		senderPlayer.setAmountOfMoney(senderPlayer.getAmountOfMoney() + 20);
		allPlayers.get(i).setAmountOfMoney(allPlayers.get(i).getAmountOfMoney() - 20);
		System.out.println(allPlayers.get(i).getName() + "has paid " + 20 + "$ to " + senderPlayer.getName() + " because of Community Card.");
	}
}
public void ActionOfTake50$AccordingToDiceValue(String actionOfCard, Bank bank, Player senderPlayer, Dice dice){
	...
	if(diceValue>8){
		...
		System.out.println("Bank has paid " + 50 + "$ to " + senderPlayer.getName() + " because of Community Card.");
	}
	else if (diceValue <= 8) {
